...
public static void logarContaGerente(ContaCorrente a, ContaPoupanca b) {
		...
		cc = encontrarLogiGerente(numCPF);
		cp = encontrarLogGerente(numCPF);
		// Login Gerente
		...
		// Login Cliente
			...
			switch (menu) {
			case 1:
				modificarCadastroGerente(cc, cp);
				break;
			case 2:
				JOptionPane.showMessageDialog(null, "Obrigado por usar os serviços da nossa agência!");
				menuGerente(a, b);
	...
	public static void modificarCadastroGerente(ContaCorrente b, ContaPoupanca c) {
		...
		JOptionPane.showMessageDialog(null, "A conta foi modificada com sucesso!");
		int menu = Integer.parseInt(JOptionPane.showInputDialog(null,
				"Confira seus dados!" + "\nConta Corrente: " + b.getNumeroConta() + "\nConta Poupança: "
						+ c.getNumeroConta() + "\nSenha: " + b.getSenha() + "\nNome: " + b.getPessoa().getNome()
						+ "\nCPF: " + b.getPessoa().modCpf() + "\nE-mail: " + b.getPessoa().getEmail() + "\n" + "\n-------------------------------------------------" + "\n|       1 - Mudar Dados Cadastrais    |" + "\n|       2 - Sair                                        |" + "\n-------------------------------------------------"+"\n"));
		switch (menu) {
		case 1:
			modificarCadastroGerente(b, c);
			break;
		case 2:
			JOptionPane.showMessageDialog(null, "Obrigado por usar os serviços da nossa agência!");
			menuGerente(b, c);
	...
	// encontrarLogin tipo "ContaPoupança"
	private static ContaPoupanca encontrarLogGerente(String numeroCPF) {
	...
	private static ContaCorrente encontrarLogiGerente(String numeroCPF) {
